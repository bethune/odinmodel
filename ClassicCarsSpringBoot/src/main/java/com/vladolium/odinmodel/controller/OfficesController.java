...
public class OfficesController {
    ...
    public Page<Offices> readAllPagination(@PathVariable Integer pageNumber, @PathVariable Integer perPageNumber) {
    ...
    public Page<Employees> readAllEmployeesByOfficesIdPagination(@PathVariable Integer pageNumber,
	    @PathVariable Integer perPageNumber, @PathVariable Long officesId) {
	Pageable page = PageRequest.of(pageNumber, perPageNumber);
	return employeesService.readAllByOfficesId(officesId, page);
    }

    @GetMapping("/search")
    public Iterable<Offices> search(@RequestParam(value = "postalCode", required = false) String postalCode,
	...
	return officesService.search(postalCode, addressLine1, country, territory, phone, city, addressLine2, state

	);
    }

    @GetMapping("/search/page={pageNumber}/perPage={perPageNumber}")
    public Page<Offices> searchPagination(@PathVariable Integer pageNumber, @PathVariable Integer perPageNumber,
	...
	return officesService.searchPagination(page, postalCode, addressLine1, country, territory, phone, city,
		addressLine2, state
