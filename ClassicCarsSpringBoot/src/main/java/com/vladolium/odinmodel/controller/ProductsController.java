...
public class ProductsController {
    ...
    @GetMapping("/search")
    public Iterable<Products> search(@RequestParam(value = "productLinesId", required = false) Long productLinesId,
	...
	return productsService.search(productLinesId,

		quantityInStock, productName, msrp, buyPrice, productDescription, productScale, productCode,
		productVendor
	...
	return productsService.searchPagination(page, productLinesId,
